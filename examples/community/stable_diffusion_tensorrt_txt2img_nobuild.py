...
class TensorRTStableDiffusionPipeline(StableDiffusionPipeline):
    ...
    def set_cached_folder(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        cls.cached_folder = (
            ...
            if os.path.isdir(pretrained_model_name_or_path)
                ...
                revision=revision,
                ignore_patterns=["*.safetensors", "*.ckpt"]
            )
        )
    ...
    def to(self, torch_device: Optional[Union[str, torch.device]] = None, silence_dtype_warnings: bool = False):
        ...
        self.onnx_dir = os.path.join("C:\\cached-model", self.onnx_dir)
        self.engine_dir = os.path.join("C:\\cached-model", self.engine_dir)
        self.timing_cache = os.path.join("C:\\cached-model", self.timing_cache)
